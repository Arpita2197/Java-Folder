...
//          O1.java:29: error: incompatible types: BDog cannot be converted to Cat
//               System.out.println(x instanceof Cat);
//                                  ^
// O1.java:30: error: incompatible types: BDog cannot be converted to Cow
//                System.out.println(x instanceof Cow);
//                                   ^
// O1.java:31: error: incompatible types: BDog cannot be converted to Plant
//                  System.out.println(x instanceof Plant);
//                                     ^
// O1.java:32: error: incompatible types: BDog cannot be converted to Human
//                   System.out.println(x instanceof Human);
//                                      ^
// 4 errors